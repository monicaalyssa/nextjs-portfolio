    ...
    <>
      ...
      <Flex direction="column" my="xs">
        <Flex direction="row" gap="sm" justify="space-between">
          <TextInput classNames={{ label: "contactLabel" }} flex={1} mb="sm" label="Name"></TextInput>
          <TextInput classNames={{ label: "contactLabel" }} flex={1} mb="sm" required label="Email"></TextInput>
          </Flex>
          <Textarea classNames={{ label: "contactLabel" }} minRows={4} required autosize placeholder="Leave feedback about my site, share career opportunities, or anything else!" mb="sm" label="Message"></Textarea>
        </Flex>
      ...
      <Button fullWidth classNames={{ section: "sendIcon" }} rightSection={<IconSend size={12.8} />} variant="default">Send Message</Button>
      <Footer />
    </> 
  );
}
