...
export default function Home() {
  ...
  return (
    <>
      ...
      <Text mt="md">Full-stack web developer based in <Anchor c={theme.colorScheme === 'dark' ? 'white' : 'black'} href="https://maps.app.goo.gl/bVj7rcHZSk8sdB7d6" target="_blank">Fort Lauderdale, Florida</Anchor>, with a curiosity for coding that began at a young age. With precision and attention to detail, I specialize in building user-friendly applications. I&apos;m constantly expanding my knowledge to stay up to date with the latest developer trends.</Text>
